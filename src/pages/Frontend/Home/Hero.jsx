...
import { Layout, Menu, Button, theme, Select, Divider, Modal, Input, Row, Col, DatePicker, message } from 'antd';
          ...
          items={[
            {
              ...
              children: [
                ...
                {
                  icon: <Link to="/calendar"><CalendarOutlined /></Link>,
                  label: "Calender"
                },
                {
            ...
            },
            {
              key: '3',
              icon: <ClearOutlined />,
              label: <p onClick={handleLogout}>Signout</p>,
            },
          ]}
        />
      </Sider>
      <Content
        style={{height:"100vh", display: "flex", flexDirection: "column", background: colorBgContainer, }}><h1 className='mx-4 mt-2'>Todos</h1>
        <Divider />
